...
const VideoDetails = () => {
  ...
  return (
    <div className="flex justify-evenly flex-row h-[calc(100%-56px)] bg-black">
      <div className="w-full  flex flex-col lg:flex-row">
        ...
        <div className="flex flex-col py-6 px-4 overflow-y-scroll hide-scrollbar lg:w-[350px] xl:w-[400px]">
